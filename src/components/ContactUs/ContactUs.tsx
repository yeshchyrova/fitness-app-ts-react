        ...
        <div className="mt-10 justify-between gap-8 md:flex">
          ...
          >
            <form
              ...
              onSubmit={onSubmit}
              method="POST"
              action="https://formsubmit.co/e.shchyrova@gmail.com"
            >
              {/* NAME INPUT */}
              <input
                type="text"
              ...
              <button
                type="submit"
                className="mt-5 rounded-lg bg-secondary-500 px-20 py-3 uppercase transition duration-300 hover:text-white"
              >
                Submit
              </button>
            </form>
